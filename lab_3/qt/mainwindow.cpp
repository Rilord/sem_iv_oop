...
void MainWindow::setup_scene() {
    ...
    std::shared_ptr<AbstractRendererFactory> factory(new QtRendererFactory(_scene));
    _Renderer = factory->create_graphics();
}

void MainWindow::update_scene() {
    RenderScene Render_command(_Renderer);
    _facade->execute(Render_command);
}
